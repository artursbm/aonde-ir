...
module.exports = (app) => {
  ...
  // pegando todos os Abrigos
  app.get('/abrigo', LocalController.indexAbrigo)
  // pegando todos os Justica
  app.get('/justica', LocalController.indexJustica)
  // // pegando todos os Infos
  app.get('/info-geral', LocalController.indexInfoGeral)
}
