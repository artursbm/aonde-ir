  ...
  watch: {
    '$route.query': {
      ...
      async handler (values) {
        this.locals = (await QuizService.indexAbrigo(values)).data
      }
    }
  }
  // async mounted () {
